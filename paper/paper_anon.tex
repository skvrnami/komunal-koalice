...
% Furthermore, I exclude city districts from the analysis because I expect that the formation of pre-electoral coalitions in them is influenced by the formation of a pre-electoral coalition on the city level. 
...
\begin{table}[!h]
\centering
\caption{Descriptive statistics of variables \label{tab:app1}}
...
\begin{table}[h]
\centering
\caption{Descriptive statistics of categorical variable \label{tab:app1b}}
\begin{adjustbox}{max width=5.5in}
{\input{desc_table2}}
\end{adjustbox}
\end{table}
...
\begin{table}[!h]
\centering
\caption{Description of the municipalities included in analysis \label{app:mun_selection}}
\begin{adjustbox}{max width=5.5in}
\input{tab_selected_municipalities}
\end{adjustbox}
\end{table}
